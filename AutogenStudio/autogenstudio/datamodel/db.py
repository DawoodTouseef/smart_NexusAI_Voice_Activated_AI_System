...
from sqlalchemy import ForeignKey, Integer, UniqueConstraint,String,Text,BigInteger
...
class Tool(SQLModel, table=True):
    ...
    user_id: Optional[str] = Field(
        default=None, sa_column=Column(Integer, ForeignKey("user.id", ondelete="CASCADE"), nullable=False)
    )
...
class User(SQLModel,table=True):
    ...
    email:str = Field(default=None,sa_column=Column(String))
    role :str = Field(default=None,sa_column=Column(String))
    profile_image_url:str = Field(default=None,sa_column=Column(Text))
    last_active_at:int =Field(default=None,sa_column=Column(BigInteger))
...
class API_KEY(SQLModel,table=True):
    __table_args = {"sqlite_autoincrement": True}
    id: Optional[int] = Field(default=None, primary_key=True)
    user_id:int=Field(
        default=None, sa_column=Column(Integer, ForeignKey("user.id", ondelete="CASCADE"), nullable=False)
